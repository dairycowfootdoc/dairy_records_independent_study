...
source(here::here('functions/fxn_disease.R')) #functions to parse remarks and protocols

events_parsed<-read_parquet(here::here('data/intermediate_files/events_formatted.parquet'))
