...
write_rds(deno365_long, here::here('milestones_dairy/data_milestones/solutions_week_05_pivotlonger.rds'))
```
...
Use this code chunk to explore your new denominator
...
Think about the data you described in milestone 4.\
Use your new data wrangling skills to create the perfect denominator for your questions about this data.

The goal for the extension is to create a usable denominator either for the disease you described in milestone 4 or for some other data of interest.
...
3)  Create a different denominator that you need to answer a question. (for some questions the best denominator is a subset of events pivoted wider)
