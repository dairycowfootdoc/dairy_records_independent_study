...
test_animal<-read_parquet(here::here('data/intermediate_files/events_formatted.parquet'))%>%
  filter(id_animal %in% '15584_09/08/12')

check_fresh<-read_parquet(here::here('data/intermediate_files/events_formatted.parquet'))%>%
  filter(event %in% 'FRESH')%>%
  mutate(floordate_month = floor_date(date_event, unit = 'month'))

check_left<-read_parquet(here::here('data/intermediate_files/events_formatted.parquet'))%>%
...
write_parquet(denominator_granular, here::here('data/intermediate_files/denominator_granular_by_DIM_group.parquet'))
...
write_parquet(denominator_time_period, here::here('data/intermediate_files/denominator_by_DIM_group.parquet'))
