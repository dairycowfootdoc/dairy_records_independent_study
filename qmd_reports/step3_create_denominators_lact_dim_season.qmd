...
date_start_deno <- date_end_deno - 365
...
# save file
write_parquet(herd_deno, here::here('data/intermediate_files/herd_denominators.parquet'))
...
# save data
write_parquet(herd_deno_dim, here::here('data/intermediate_files/herd_dim_denominators.parquet'))
```
...
# save data
write_parquet(monthly_data, here::here('data/intermediate_files/herd_season_denominators.parquet'))
