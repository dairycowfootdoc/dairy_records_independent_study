...
list_files<-list.files('list_files <- list.files("C:\\Users\\srmh0\\Animal Clinic Dropbox\\AC LA\\LA Doctors\\Sarah\\Bovine\\DC305 R Data Pulls\\MV")') #folder name where event files are located
