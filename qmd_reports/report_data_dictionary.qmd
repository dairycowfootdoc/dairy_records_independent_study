...
list_intermediate_files<-list.files(here::here('data/intermediate_files'))

fxn_graph_file_skim <- function(file_name) {
  df <- read_parquet(here::here('data/intermediate_files', file_name))
  sk_df <- skimr::skim(df) %>%
...
calendar_options<-read_parquet(here::here('data/intermediate_files/denominator_by_calendar_time_period.parquet'))
